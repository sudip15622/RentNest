...
const CreateListingForm = () => {
  ...
  const onSubmit: SubmitHandler<RoomListingFormType> = async (data) => {
    try {
      ...
      if (
        !termsAccepted.accuracy ||
        !termsAccepted.terms ||
        !termsAccepted.communication
      ) {
      ...
      // Step 2: Prepare data with frontend schema structure (no transformation yet)
      ...
      // Step 3: Send to createListing action (validation + transformation happens there)
      const response = await createListing(listingData);

      if (response?.success) {
        toast("Listing successful1", "success");
        router.push("/");
        ...
        if (response?.errors) {
          Object.entries(response?.errors).forEach(([field, messages]) => {
            if (Array.isArray(messages) && messages.length > 0) {
              ...
              const frontendFieldMap: Record<
                string,
                keyof RoomListingFormType
              > = {
                title: "title",
              ...
              const frontendField = frontendFieldMap[field];
              if (frontendField) {
          ...
          toast("Please fix the validation in all fields!", "error");
          return;
        }
      ...
      toast("There was an unexpected error. Please try again.", "error");
    }
  };
    ...
    <main className="page-content">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="bg-white rounded-2xl shadow-lg border border-[var(--border)] p-6 sm:p-8 mb-8">
            {" "}
            {/* Step 1: Basic Info */}
            {currentStep === 1 && (
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <InputWithoutLabel
                        field={field}
                        error={fieldState.error}
                        placeholder="e.g., Pragati marga, Pulchwok"
                        type="text"
                      />
                    )}
                  />
              ...
              <div className="space-y-6">
                ...
                <div className="text-center mb-6">
                  <p className="text-[var(--foreground-sec)] mb-2">
                    Add high-quality photos to showcase your room and attract
                    more tenants
                  </p>
                  <p className="text-sm text-[var(--foreground-sec)]">
                    You can upload up to 10 photos. The first photo will be your
                    main listing image.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                        ...
                        {watchedPhotos.map((file, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <p
                                className="text-xs text-[var(--foreground-sec)] mt-1 truncate"
                                title={file.name}
                              >
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>
                        • Take photos in good lighting (natural light works
                        best)
                      </li>
                      <li>• Show the room from different angles</li>
                      <li>
                        • Include photos of bathroom, kitchen access if
                        available
                      </li>
                  ...
                  <div className="space-y-2">
                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        min: {
                          value: 1000,
                          message: "Minimum rent should be Rs. 1,000",
                        },
                        max: {
                          value: 100000,
                          message: "Maximum rent should be Rs. 100,000",
                        },
                      }}
                      render={({ field, fieldState }) => (
                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        max: {
                          value: 200000,
                          message:
                            "Maximum security deposit should be Rs. 200,000",
                        },
                      }}
                      render={({ field, fieldState }) => (
                        <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Controller
                        ...
                        control={control}
                        rules={{
                          required: "Utilities option is required!",
                        }}
                        render={({ field, fieldState }) => (
                          <SelectWithoutLabel
                            field={field}
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-semibold text-[var(--foreground)]">
                        Internet/WiFi <span className="text-red-500">*</span>
                      </label>
                      <Controller
                        name="internetIncluded"
                        control={control}
                        rules={{
                          required: "Internet option is required!",
                        }}
                        render={({ field, fieldState }) => (
                          <SelectWithoutLabel
                            field={field}
            ...
            {currentStep === 4 && (
              <div className="space-y-8">
                <div className="text-center">
                  ...
                  <p className="text-[var(--foreground-sec)]">
                    Please review all the details before submitting your room
                    listing
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="font-medium text-[var(--foreground-sec)]">
                          Title:
                        </span>
                      ...
                      <div>
                        ...
                        <p className="text-[var(--foreground)]">
                          {watch("bedrooms")} bedroom(s), {watch("bathrooms")}{" "}
                          bathroom(s)
                        </p>
                      </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-[var(--foreground)] font-semibold text-lg">
                          Rs.{" "}
                          {watch("securityDeposit")?.toLocaleString() || "0"}
                        </p>
                      </div>
                      <div>
                        <span className="font-medium text-[var(--foreground-sec)]">
                      ...
                      <div>
                        ...
                        <p className="text-[var(--foreground)]">
                          {watch("leaseDuration") || "Not specified"}
                        </p>
                      </div>
                    ...
                    <div className="space-y-3 text-sm text-[var(--foreground-sec)]">
                      <label className="flex items-start gap-3">
                        ...
                        <span>
                          ...
                          accurate and up-to-date. I understand that false
                          information may result in my listing being removed.
                        </span>
                      </label>
                      <label className="flex items-start gap-3">
                        <input
                        ...
                        />
                        <span>
                          I agree to RentNest's Terms of Service and Privacy
                          Policy. I understand the platform fees and commission
                          structure.
                        </span>
                      </label>
                      <label className="flex items-start gap-3">
                        ...
                        />
                        <span>
                          I commit to responding to inquiries promptly and
                          maintaining professional communication with potential
                          tenants.
                        </span>
                      </label>
                    </div>
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[var(--foreground-sec)]">
                            Your listing will be live and visible to potential
                            tenants right away
                          </p>
                        </div>
                      </label>
                      <label className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[var(--foreground-sec)]">
                            Save your listing and publish it later from your
                            dashboard
                          </p>
                        </div>
                      </label>
